...
import { RetailerSettingsCard } from '@/components/settings/retailer-settings-card';
      ...
      <Tabs defaultValue="retailer" className="space-y-6">
        ...
        <TabsContent value="retailer" className="space-y-4">
          <RetailerSettingsCard
            ...
            setRetailerSettings={setRetailerSettings}
            savingRetailer={savingRetailer}
            updateRetailerSettings={updateRetailerSettings}
